    ...
    <footer className="mt-8 border-t border-border">
      <div className="container relative mx-auto flex h-16 items-center justify-between px-4">
        <p className="text-sm text-muted-foreground">
          Made with{" "}
          <span
            className="mx-[2px] inline-block h-5 w-5 translate-y-[4px] rounded-[6px] bg-[url('/cursor-logo.png')] bg-contain bg-center bg-no-repeat"
            title="Cursor"
            aria-label="Cursor"
          />{" "}
          and{" "}
          <span className="text-lg font-extrabold text-destructive" title="Love" aria-label="Love">
            ♥️
          </span>{" "}
          by{" "}
